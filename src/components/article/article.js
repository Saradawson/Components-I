...
const data = [
  ...
  },
  {
    title: 'GWMR',
    date: 'March 8th, 2018',
    firstParagraph: 'All girl band',
    secondParagraph: 'Based in PHX',
    thirdParagraph: 'Original Music'
...
function articleMaker({ date, title, firstParagraph, secondParagraph, thirdParagraph }) {
